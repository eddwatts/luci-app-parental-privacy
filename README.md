...
```sh
opkg install luci-app-parental-privacy_1.3.0_all.ipk
```
...
| `luci-app-parental-privacy.json` | `/usr/share/luci/menu.d/` and `/usr/share/rpcd/acl.d/` | LuCI menu entry and ACL |
